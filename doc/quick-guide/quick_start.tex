...
The GPU module has a few parameters in the \code{gpu\_run\_pars} namelist, most relevant:
\command{lac\_sparse\_autotuning} set to ``T" will accelerate the preliminaries noticeably.
